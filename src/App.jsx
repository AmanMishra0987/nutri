          ...
          <div className="fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out md:hidden">
            ...
            <nav className="p-6">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <button className="w-full bg-emerald-600 text-white px-6 py-3 rounded-full hover:bg-emerald-700 transition-colors font-medium">
                  Book a Session
                </button>
              </div>
            </nav>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="mb-12 lg:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-emerald-900 leading-tight">
                Nourish Your Body,{" "}
                <span className="text-emerald-600">Energize Your Soul</span>
              </h1>
              <p className="mt-6 text-lg text-gray-600 max-w-2xl">
                Experience holistic wellness through our personalized nutrition
                plans, mindfulness practices, and lifestyle coaching designed to
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                ...
                nurturing the whole self - body, mind, and spirit. Founded in
                2015, our mission is to empower individuals to achieve optimal
                health through personalized wellness solutions that are
                sustainable and meaningful.
              </p>
              <p className="text-gray-600 mb-6">
                We envision a world where everyone has access to holistic
                wellness resources that support their unique journey toward
                vitality and balance. Our approach combines evidence-based
                nutrition science with mindfulness practices and lifestyle
                coaching.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                Personalized meal plans and nutritional guidance tailored to
                your health goals, dietary preferences, and lifestyle.
              </p>
              <Link
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                Holistic programs combining nutrition, fitness, and mindfulness
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                One-on-one coaching to help you develop sustainable habits and
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                Interactive group sessions on various wellness topics to educate
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                Immersive wellness experiences in serene natural settings to
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6">
                ...
                journeys through our supportive community.
              </p>
              <Link
