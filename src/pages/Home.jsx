            ...
            <div className="space-y-8 lg:order-1">
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                ...
                <p className="font-medium text-emerald-700">
                  Driven by my experiences, I enrolled in a Precision Nutrition course to empower others facing similar struggles. My mission is to share knowledge and help those impacted by PCOD and post-pregnancy weight gain lead healthier, happier lives.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {IMAGES.gallery.slice(0, 3).map((mediaUrl, index) => {
              ...
              return (
                <div
                  key={index}
                  className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 bg-gray-100 flex items-center justify-center min-h-[180px]"
                >
                  {isVideo ? (
                    <video
                      src={mediaUrl}
